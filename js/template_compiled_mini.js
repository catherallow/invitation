    ...
    for (var w = 0; w < 3; w++) {
        ...
        if (parent.data_value['WISH_TEXT_ITEMS_' + w] && typeof (parent.data_value['WISH_TEXT_ITEMS_' + w]) != 'undefined') {
            if (parent.data_value['WISH_TEXT_ITEMS_' + w] != '') {
                console.log('<div class="' + classListItem.join(' ') + '"><' + tagNameSlide + ' class="' + classListSlide.join(' ') + '" data-sm-text="WISH_TEXT_ITEMS_' + w + '" title="' + parent.data_value['WISH_TEXT_ITEMS_' + w].replace(/<[^>]*>/g, '') +
                    '">' + parent.data_value['WISH_TEXT_ITEMS_' + w] + '</' + tagNameSlide + '></div>');
                $(wishSlider).append('<div class="' + classListItem.join(' ') + '"><' + tagNameSlide + ' class="' + classListSlide.join(' ') + '" data-sm-text="WISH_TEXT_ITEMS_' + w + '" title="' + parent.data_value['WISH_TEXT_ITEMS_' + w].replace(/<[^>]*>/g, '') +
                    '">' + parent.data_value['WISH_TEXT_ITEMS_' + w] + '</' + tagNameSlide + '></div>');
                countSlides++;
            }
        } else {
            if (parent.data_value['WISH_TEXT_ITEMS'] && parent.data_value['WISH_TEXT_ITEMS'].length > 0) {
                if (parent.data_value['WISH_TEXT_ITEMS_' + w] != '') {
                    $(wishSlider).append('<div class="' + classListItem.join(' ') + '"><' + tagNameSlide + ' class="' + classListSlide.join(' ') + '" data-sm-text="WISH_TEXT_ITEMS_' + w + '" title="' + parent.data_value['WISH_TEXT_ITEMS'][w].replace(/<[^>]*>/g, '') +
